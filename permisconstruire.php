...
<head>
    ...
    <title>Demande de permis de conduire</title>
...
<style>
      #back {
        background-image: url("./image/batimen.jpg");  
...
<body>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content rounded-4 shadow">
            <div class="modal-header p-5 pb-4 border-bottom-0">
              <h1 class="fw-bold mb-0 fs-2">Permis de construction</h1>
            ...
            <div class="modal-body p-5 pt-0">
              <form action="" method="POST">
                <div class="form-floating mb-3">
                  <input type="texte" class="form-control rounded-3" id="adresseprojet" placeholder="Adresse du projet" name="adresseprojet">
                  <label for="adresseprojet"><strong>Adresse du projet</strong> </label>
                </div>

                <div class="form-floating mb-3">
                  <input type="texte" class="form-control rounded-3" id="cinconstruire" placeholder="CIN " name="cinconstruire">
                  <label for="cinconstruire"><strong>CIN</strong></label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control rounded-3" id="description" placeholder="Description " name="description">
                    <label for="description"><strong>Description</strong></label>
                </div>

                <div class="form-floating mb-3">
                    <input type="texte" class="form-control rounded-3" id="prixconstruire" placeholder="Prix" name="prixconstruire">
                    <label for="prixconstruire"><strong>Prix</strong></label>
                  </div>
    ...
    if(isset($_POST['envoyer']))
    {
        ...
        $adresseprojet = $_POST['adresseprojet'];
        $cinconstruire = $_POST['cinconstruire'];
        
        $description = $_POST['description'];
        $prixconstruire = $_POST['prixconstruire'];

        insertDataConstruire($cinconstruire, $username, $adresseprojet, $description, $prixconstruire);
    }
