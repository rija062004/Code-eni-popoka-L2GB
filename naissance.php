...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@docsearch/css@3">
     ...
     <style>
      #bak {
        background-image: url("./image/naiss.jpg");  
...
<div class="container">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content rounded-4 shadow">
            <div class="modal-header p-5 pb-4 border-bottom-0">
              <h1 class="fw-bold mb-0 fs-2">Demande Acte de Naissance</h1>
            ...
            <div class="modal-body p-5 pt-0">
              <form action="" method="POST">
                <div class="form-floating mb-3">
                  <input type="texte" class="form-control rounded-3" id="nomnaissance" placeholder="Nom" name="nomnaissance">
                  <label for="nomnaissance"><strong>Nom</strong></label>
                </div>

                <div class="form-floating mb-3">
                  <input type="texte" class="form-control rounded-3" id="prenomnaissance" placeholder="Prénoms " name="prenomnaissance">
                  <label for="prenomnaissance"><strong>Prénoms</strong></label>
                </div>
                <div class="form-floating mb-3">
                    <input type="date" class="form-control rounded-3" id="datenaissance" placeholder="CIN du demandeur " name="datenaissance">
                    <label for="datenaissance"><strong>Date de naissance</strong></label>
                </div>

                <div class="form-floating mb-3">
                    <input type="texte" class="form-control rounded-3" id="lieunaissance" placeholder="lieu de naissance" name="lieunaissance">
                    <label for="lieunaissance"> <strong> Lieu de naissance</strong></label>
                  </div>
                 
                <div class="form-floating mb-3">
                  <input type="text" class="form-control rounded-3" id="nombre" placeholder="Nombres du mariage" name="nombre">
                  <label for="nombre"> <strong>Nombres de copie</strong></label>
                </div>

                <div class="form-floating mb-3">
                    <input type="texte" class="form-control rounded-3" id="prix" placeholder="Prix" name="prix">
                    <label for="prix"><strong>Prix</strong></label>
                  </div>

                
                 <div class="mb-3">
                    <input type="submit" class="form-control btn btn-primary btn-lg"  value="Demander" id="ajouter" name="ajouter">
                    </div>
    ...
    {
        insertDataNaissance($_SESSION['username'], $_POST['nomnaissance'], $_POST['prenomnaissance'], $_POST['datenaissance'], $_POST['lieunaissance'], $_POST['nombre'], $_POST['prix']);
    }
