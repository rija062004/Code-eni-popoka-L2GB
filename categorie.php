        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content rounded-4 shadow">
            <div class="modal-header p-5 pb-4 border-bottom-0">
              <h1 class="fw-bold mb-0 fs-2">Categorie d'Impot</h1>
            ...
            <div class="modal-body p-5 pt-0">
              <form action="crud.php" method="POST">
                <div class="form-floating mb-3">
                  <input type="text" class="form-control rounded-3" id="floatingInput" placeholder="" name="cat">
                  <label for="floatingInput"><strong>Catégorie</strong></label>
                </div>
                <div class="form-floating mb-3">
                  <input type="number" class="form-control rounded-3" id="floatingPassword" placeholder="Password" name="tar">
                  <label for="floatingPassword"><strong>Tarif</strong></label>
                </div>
                <div class="mb-3">
                    <input type="submit" class="form-control btn btn-primary btn-lg"  value="Ajouter" id="exampleFormControlInput1" name="categorie">
                </div>
